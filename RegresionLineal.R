...
#creando el model
lm.modelo <- lm(Petal.Width~Petal.Length, data= irisDT) #predecir ancho por [largo]
...
#calculo RMSE
rmse <- sqrt(mean((irisDT$Petal.Width-irisDT$pred)^2))  #error 0.2 contando los valores mas grandes
